...
function Navbar({scrollToSection,className,hover}) {
  ...
  return (
    <>
        <nav className={`flex fixed z-20 ${isScrolled && "bg-[#f5f5f5]" } ${className} transition-all duration-700 ease-in-out transform  md:px-8 p-3 items-center w-full justify-between`}>
            <div>
