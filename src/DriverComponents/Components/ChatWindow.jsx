...
function ChatWindow() {
  return (
    <>
        <div className='h-full hidden pt-16 md:block flex-1 bg-gradient-to-b from-[#ade9dc] via-[#cef3eb] p-3 to-[#8feed9] overflow-y-auto overflow-x-hidden'>
            ...
            <div className=' flex px-5 items-center h-9 absolute w-[74.5%] right-1 bottom-1 '>
                <div className='text-lg'><FontAwesomeIcon icon={faPaperclip} /></div>
                <div className='flex-1 px-2 z-10 shadow-lg'><input type="text" className=' w-full py-0.5 rounded-[24px] pl-2' placeholder='Enter anything....' /></div>
